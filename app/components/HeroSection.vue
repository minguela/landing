...
<template>
  <section id="top" class="shell section-space pt-14 sm:pt-20 lg:pt-24">
    <div class="glass-panel relative overflow-hidden px-6 py-8 sm:px-8 sm:py-10 lg:px-12 lg:py-14">
